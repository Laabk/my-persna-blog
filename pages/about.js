  ...
  return (
    <div className="min-h-screen relative bg-white dark:bg-gray-900">
      ...
      <div className="max-w-2xl pt-20 pb-32 px-6 text-center mx-auto">
        ...
        I am a self-taught developer and chemical engineer currently pursuing an Full Software Engineering
        in HoLberton School.
        My interests lie in developing innovative web technologies and products, offline Applications as
        well as exploring areas related to innovative chemical engineering, deep learning, and natural language processing.
        </p>
